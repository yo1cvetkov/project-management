...
-- AddForeignKey
ALTER TABLE "Task" ADD CONSTRAINT "Task_assingedUserId_fkey" FOREIGN KEY ("assingedUserId") REFERENCES "User"("userId") ON DELETE SET NULL ON UPDATE CASCADE;
